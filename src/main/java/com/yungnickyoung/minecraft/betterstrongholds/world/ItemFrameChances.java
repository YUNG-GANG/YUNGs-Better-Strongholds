...
/**
 * Singleton class holding ItemSetSelectors for items in item frames.
...
public class ItemFrameChances {
    ...
    private ItemFrameChances() {
        armouryItems = new ItemSetSelector(Items.AIR)
        ...
        storageItems = new ItemSetSelector(Items.AIR)
    ...
    private ItemSetSelector armouryItems;
    private ItemSetSelector storageItems;
